...
시험기간 + 다른 할일이 겹쳐 오래 글을 못 썼는데, 이번 에 동아리+학부 차원에서 CTF를 열었다가 친구 문제에서 배울 게 있어서 정리도 할겸 써보겠습니다. 친구 문제의 시나리오는 다음과 같습니다.
...
CSRF 는 다른 문제에서도 많이 공부해볼 수 있어서 간단히 링크만 남겨드리고, HTTP Smuggling attack이 뭔지, 예제를 풀어보면서 공부해보겠습니다.
